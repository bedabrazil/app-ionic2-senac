...
export class ContactService{
  public academic: Academic = new Academic('Senac Nações Unidas', 'Av. Engenheiro Eusébio Stevaux, 823 - Santo Amaro São Paulo - SP  CEP: 04696-000', '(11) 5682-7300  Fax:(11) 5682-7441', 'nacoesunidas@sp.senac.br', '', 'assets/img/senac.jpg');
